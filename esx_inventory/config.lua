...
Config.OpenControl = 37 -- Key for opening inventory. Edit html/js/config.js to change key for closing it.
...
Config.CloseUiItems = {"headbag", "fishingrod", "bobbypin", "mechanic_repairkit"}
